...
class BiobankOrderIdentifier(BiobankOrderIdentifierBase, BaseModel):
...
class BiobankOrderedSampleBase(ModelMixin):
    ...
    def biobankOrderId(cls):
        return Column(
            'order_id', String(80), ForeignKey('biobank_order.biobank_order_id'))
    ...
    __table_args__ = (
        UniqueConstraint('order_id', 'test'),
    )


class BiobankOrderedSample(BiobankOrderedSampleBase, BaseModel):
...
class BiobankOrderedSampleHistory(BiobankOrderedSampleBase, BaseModel):
    __tablename__ = 'biobank_ordered_sample_history'

    version = Column('version', Integer, unique=True)


class BiobankOrderIdentifierHistory(BiobankOrderIdentifierBase, BaseModel):
