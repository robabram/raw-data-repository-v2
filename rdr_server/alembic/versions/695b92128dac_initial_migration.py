...
Revision ID: 695b92128dac
Revises:
Create Date: 2019-02-22 16:19:47.747690
...
def upgrade_rdrv2():
    ...
    sa.Column('enrollment_status', ModelEnum(EnrollmentStatus), nullable=True),
    sa.Column('sample_status', ModelEnum(SampleStatus), nullable=True),
    ...
    sa.Column('organization_type', ModelEnum(OrganizationType), nullable=True),
    sa.Column('is_obsolete', ModelEnum(ObsoleteStatus), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('status', ModelEnum(QuestionnaireDefinitionStatus), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('code_type', ModelEnum(CodeType), nullable=False),
    ...
    sa.Column('site_status', ModelEnum(SiteStatus), nullable=True),
    sa.Column('enrolling_status', ModelEnum(EnrollingStatus), nullable=True),
    sa.Column('digital_scheduling_status', ModelEnum(DigitalSchedulingStatus), nullable=True),
    ...
    sa.Column('withdrawal_status', ModelEnum(WithdrawalStatus), nullable=False),
    sa.Column('withdrawal_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('withdrawal_reason', ModelEnum(WithdrawalReason), nullable=True),
    sa.Column('withdrawal_reason_justification', sa.UnicodeText(), nullable=True),
    sa.Column('suspension_status', ModelEnum(SuspensionStatus), nullable=False),
    ...
    sa.Column('order_status', ModelEnum(BiobankOrderStatus), nullable=True),
    ...
    sa.Column('status', ModelEnum(SampleStatus), nullable=True),
    ...
    sa.Column('enrollment_status', ModelEnum(EnrollmentStatus), nullable=True),
    sa.Column('race', ModelEnum(Race), nullable=True),
    sa.Column('physical_measurements_status', ModelEnum(PhysicalMeasurementsStatus), nullable=True),
    ...
    sa.Column('consent_for_study_enrollment', ModelEnum(QuestionnaireStatus), nullable=True),
    sa.Column('consent_for_study_enrollment_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('consent_for_electronic_health_records', ModelEnum(QuestionnaireStatus), nullable=True),
    sa.Column('consent_for_electronic_health_records_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('consent_for_dv_electronic_health_records_sharing', ModelEnum(QuestionnaireStatus), nullable=True),
    sa.Column('consent_for_dv_electronic_health_records_sharing_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('consent_for_cabor', ModelEnum(QuestionnaireStatus), nullable=True),
    sa.Column('consent_for_cabor_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('questionnaire_on_overall_health', ModelEnum(QuestionnaireStatus), nullable=True),
    sa.Column('questionnaire_on_overall_health_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('questionnaire_on_lifestyle', ModelEnum(QuestionnaireStatus), nullable=True),
    sa.Column('questionnaire_on_lifestyle_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('questionnaire_on_the_basics', ModelEnum(QuestionnaireStatus), nullable=True),
    sa.Column('questionnaire_on_the_basics_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('questionnaire_on_healthcare_access', ModelEnum(QuestionnaireStatus), nullable=True),
    sa.Column('questionnaire_on_healthcare_access_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('questionnaire_on_medical_history', ModelEnum(QuestionnaireStatus), nullable=True),
    sa.Column('questionnaire_on_medical_history_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('questionnaire_on_medications', ModelEnum(QuestionnaireStatus), nullable=True),
    sa.Column('questionnaire_on_medications_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('questionnaire_on_family_health', ModelEnum(QuestionnaireStatus), nullable=True),
    sa.Column('questionnaire_on_family_health_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1sst8', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1sst8_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_2sst8', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_2sst8_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1ss08', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1ss08_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1pst8', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1pst8_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_2pst8', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_2pst8_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1ps08', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1ps08_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1hep4', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1hep4_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1ed04', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1ed04_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1ed10', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1ed10_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_2ed10', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_2ed10_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1ur10', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1ur10_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1ur90', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1ur90_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1sal', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1sal_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1sal2', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1sal2_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1ed02', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1ed02_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1cfd9', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1cfd9_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_status_1pxr2', ModelEnum(SampleStatus), nullable=True),
    sa.Column('sample_status_1pxr2_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1sst8', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1sst8_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_2sst8', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_2sst8_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1ss08', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1ss08_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1pst8', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1pst8_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_2pst8', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_2pst8_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1ps08', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1ps08_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1hep4', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1hep4_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1ed04', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1ed04_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1ed10', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1ed10_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_2ed10', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_2ed10_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1ur10', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1ur10_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1ur90', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1ur90_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1sal', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1sal_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1sal2', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1sal2_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1ed02', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1ed02_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1cfd9', ModelEnum(OrderStatus), nullable=True),
    sa.Column('sample_order_status_1cfd9_time', UTCDateTime(fsp=6), nullable=True),
    sa.Column('sample_order_status_1pxr2', ModelEnum(OrderStatus), nullable=True),
    ...
    sa.Column('samples_to_isolate_dna', ModelEnum(SampleStatus), nullable=True),
    sa.Column('biospecimen_status', ModelEnum(OrderStatus), nullable=True),
    ...
    sa.Column('status', ModelEnum(PhysicalMeasurementsStatus), nullable=True),
    sa.Column('cancelled_username', sa.String(length=255), nullable=True),
    sa.Column('cancelled_site_id', sa.Integer(), nullable=True),
    sa.Column('cancelled_time', UTCDateTime(fsp=6), nullable=True),
...
def upgrade_metricsv2():
    ...
    sa.Column('metric_set_type', ModelEnum(MetricSetType), nullable=False),
    sa.Column('last_modified', UTCDateTime(fsp=6), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('modified', mysql.DATETIME(fsp=6), server_default=sa.text('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('metric_set_id', sa.String(length=50), nullable=True),
    sa.Column('metrics_key', ModelEnum(MetricsKey), nullable=True),
