...
from rdr_server.common.misc import which
...
if __name__ == '__main__':
    ...
    try:
        sdk_path = which('dev_appserver.py')
        if sdk_path:
            sdk_path = os.path.dirname(os.path.dirname(sdk_path))
    except:
        sdk_path = None

    try:
        from rdr_server import tests as mod
        test_path = os.path.abspath(mod.__file__)
        mod = None
    except:
        test_path = os.getcwd()
